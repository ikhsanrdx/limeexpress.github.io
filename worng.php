...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-warning shadow">
        <div class="container">
            <a class="navbar-brand" href="#"><img src="logo.png" class="w-50 mb-2" alt=""></a>
     ...
     <table class="table table-bordered table-hover text-center text-danger">
       <thead>
         <tr>
           <th>No. RESI yang anda masukan tidak terdaftar</th>
         </tr>
       </tbody>
     </table>
     </div>
